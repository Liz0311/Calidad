...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2018 a las 02:42:23
...
(1, 'PAPAFE72', 'MEMAXX78', 'Finalizado', '2018-05-21', 11),
(2, 'PAPAFE72', 'MEMAXX78', 'Pendiente', '2018-06-04', 11),
(3, 'PAPAFE72', 'MEMAXX78', 'Finalizado', '2018-05-28', 11),
(4, 'PA', 'MEMAXX78', 'Finalizado', '2018-05-14', 9);
...
('MEMAXX78', 'UNMSM', 'Doctorado', 'CARD', 'LUMA'),
('REPAPA72', 'San marcos', 'bachiller', 'UROL', 'JUMA');
...
INSERT INTO `resultado` (`res_codigo`, `res_diagnostico`, `res_sintomas`, `res_cod_hc`, `res_cod_cita`) VALUES
(1, 'gripe', 'fiebre', 1, 3);
...
--
ALTER TABLE `cita`
  MODIFY `c_codigo` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `historia_clinica`
--
ALTER TABLE `historia_clinica`
  MODIFY `hc_codigo` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `resultado`
  MODIFY `res_codigo` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
